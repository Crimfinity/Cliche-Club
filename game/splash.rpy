init python:
    menu_trans_time = 1
    splash_message_default = "Middle Text"
    splash_messages = [
    "You are my sunshine,\nMy only sunshine",
    "I missed you.",
    "Play with me",
...
transform menu_sans:
    ...
    parallel:
        xoffset 0 yoffset 0
        linear 5.0 xoffset -400 yoffset -400
        #repeat
    parallel:
        ypos 0
        time 0.65
...
image intro:
    ...
    "white"
    0.5
    "mod_assets/cdsplash.png" with Dissolve(0.5, alpha=True)
    2.5
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "Something something fan mod not affiliated with team salvato that should be played after the base game and original files can be downloaded from ddlc.moe."
        menu:
            "By playing Doki Doki Cliche Club, you agree you read the last line."
            "I agree.":
                pass
