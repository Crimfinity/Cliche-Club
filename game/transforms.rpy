...
transform ifocus(x=640, z=0.80):
    yanchor 1.0 ypos 1.03 subpixel True
    on show:

        
        xcenter x yoffset -20
        yoffset 0 zoom z*1.05 alpha 1.00
        yanchor 1.0 ypos 1.03
    on replace:
        alpha 1.00
        parallel:
...
transform rightin(x=640, z=0.80):
    xcenter 1310 yoffset 0 yanchor 1.0 ypos 1.03 zoom z*1.00 alpha 1.00 subpixel True
    easein .25 xcenter x
...
define wipefast = MultipleTransition([
    False, ImageDissolve("images/menu/wipeleft.png", 0.25, ramplen=64),
    Solid("#000"), Pause(0.15),
    Solid("#000"), ImageDissolve("images/menu/wipeleft.png", 0.25, ramplen=64),
    True])
...
transform tealikenises:
    ...
    parallel:
        block:
            linear 2.25 rotate 10000
    parallel:
        block:
            ease .75 xoffset 800
            ease 1.5 xoffset 1200 alpha 0 zoom 0 yoffset -20
