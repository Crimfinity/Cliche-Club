...
unreleased tension experienced by my entire body. Her Third Eye is drawing me closer."""
    ...
    text = """\
peoplee r mean
they make me wan't to scream
noone else is nice to me 
but you dont hate me 

you make me feel funny
like butterfly in my tummy 
everyday with you is sunny
so tell me you love me
click outside of poem to continue"""
    )
...
I want breakfast."""
    ...
    title = "",
    text = """\
This is an example of the power of the SELF DEFENCE NOOSE!!! Get yours for only 19.99 today!"""
    )
