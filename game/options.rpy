...
define config.name = "Doki Doki Cliche Club"
...
define config.save_directory = "DDCCwhyisappdatahidden"
...
define config.window_icon = "mod_assets/cclogo.png"
...
define config.layers = ['bzm', 'master', 'cover', 'transient', 'screens', 'overlay', 'front' ]
